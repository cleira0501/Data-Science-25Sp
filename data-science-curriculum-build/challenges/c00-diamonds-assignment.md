...
**Observations**: It is interesting to see how in the bigger carat(2.5+)
range, the cut quality are generally not as good. It makes me wonder if
that is caused by the different purposes of big diamonds verses small
diamonds. We can observe a generally positive relationship between cut
quality and price, indicating that better quality cuts tends to fetch
higher prices. Although you can also observe there are a lot of overlap
between the data points in cut quality. Suggesting that there are other
factors influencing prices of diamonds.
